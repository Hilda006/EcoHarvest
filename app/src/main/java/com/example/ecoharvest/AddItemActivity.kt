            ...
            storageReference.putFile(it).addOnCompleteListener {task ->
                if (task.isSuccessful) {
                    storageReference.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        addData["name"] = binding.descriptionInput.text.toString()
                        addData["price"] = binding.priceInput.text.toString()
                        addData["quantity"] = binding.typeInput.text.toString()
                        ...
                        firebaseFirestore.collection("data").add(addData)
                            .addOnCompleteListener { taskUpload ->
                                ...
                                binding.imageView.setImageResource(R.drawable.add_a_photo)
